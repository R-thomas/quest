 ...
 *
 * The followings are the available columns in table '{{quests}}':
 * @property integer $id
...
class Quests extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
            ...
            array('image','file','types'=>'jpg, jpeg, png', 'message'=>'Добавьте изображение'),
	...
	public function relations()
	{
		...
		return array(
            'times' => array(self::HAS_MANY, 'Time', 'quest_id'),
		);
	}
    ...
    public function deleteDocument(){
        $documentPath=self::IMAGE_PATH . '/' . $this->image;
