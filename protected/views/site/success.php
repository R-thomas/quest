<div class="container-fluid bg_order">
    ...
    <div class="row form-order-row">
        ...
        <div class="col-md-12 col-sm-12 col-xs-12 sucsess_row">
        <h1 class="text-uppercase success_h1">Спасибо за заявку</h1>
            <img src="../../../images/arrow.png" width="245" height="19" class="img-responsive center-block arrow_img_success"/>
            <p class="text-uppercase success_p">В ближайшее время мы с вами свяжемся</p>
            <img src="../../../images/phone.png" width="127" height="100" class="img-responsive center-block img_phone"/>
            <div class="div_link_success"><a href="/site" class="link_success">Вернуться на главную</a></div>
        </div>
    </div>
